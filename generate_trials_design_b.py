...
# Si el target candidato es 1-refreshing, selecciona al azar de entre las arrows 3° y 4°
target_disco = []
...
for ensayo in range(395):
    ...
    if refrescamientos.loc[ensayo , "candi_target"] == 'uno_refrescado':
        target_disco.append(random.choice(list(refrescamientos.loc[ensayo , "arrow_3":"arrow_4"]))) # Experimento 1B (Pág. 22 de Souza, Rerko y Oberauer, 2015)
...
refrescamientos.to_csv('design/trials_design_b.csv', index = False, header = True, sep = ";")